...
export const configNewsletter = program => {
  program.command('newsletter')
    .description('Newsletter')
    .argument('[topic]', 'What topic do you want to discuss?', 'How to write articles')
...
export const generateNewsletter = async ({contentType, number, topic, output, words}) => {
